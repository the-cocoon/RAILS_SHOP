module RailsShop
  module YandexKassaTestActions
    extend ActiveSupport::Concern

    included do
      skip_before_action :verify_authenticity_token, only: %w[
        yk_check_test
        yk_aviso_test
        yk_success_test
        yk_failure_test
    ...
    def yk_check_test
      ...
      @shop_id      = Settings.rails_shop.shop_id
      ...
      render template: 'payments/check_order', formats: :xml
    ...
    def yk_aviso_test
      ...
      render template: 'payments/payment_aviso', formats: :xml
    ...
    def yandex_md5_check action, params
      shop_id      = Settings.rails_shop.shop_id
      shop_pass    = Settings.rails_shop.shop_password
      invoice_id   = params[:invoiceId]
